...
const categories = Array.from(new Set(trustReports.map((r) => r.category)))
    ...
    <div>
      ...
      <div className="relative mb-5">
        ...
        <input
          ...
          placeholder="Search by product or brand&hellip;"
              ...
              >
                <div className="mb-4 flex items-center justify-between">
                  <div className="flex size-14 items-center justify-center overflow-hidden rounded-xl bg-muted">
                    ...
                    <img src={r.image || "/placeholder.svg"} alt={r.productName} className="size-full object-cover" />
                  </div>
